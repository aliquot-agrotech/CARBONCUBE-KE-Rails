class Purchaser::BuyForMeOrdersController < ApplicationController
  ...
  def create
    ...
    ActiveRecord::Base.transaction do
      ...
      buy_for_me_order_cart_items = current_purchaser.buy_for_me_order_cart_items
      ...
      @buy_for_me_order = current_purchaser.buy_for_me_orders.new(
        # status: 'Processing',
