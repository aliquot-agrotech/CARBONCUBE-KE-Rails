...
products = [
  # Filtration Solutions
    ...
    # Hardware Items
    { title: 'Cordless Drill', description: 'Powerful cordless drill with multiple torque settings and LED light.', media: ['cordless_drill.jpg'], category_id: Category.find_by(name: 'Hardware Items').id, vendor_id: Vendor.third.id, price: 129.99, quantity: 40, brand: 'MaxDrill', manufacturer: 'ToolTech', package_length: 14, package_width: 6, package_height: 10, package_weight: 2.5 },
    { title: 'Tool Chest', description: 'Large tool chest with drawers and wheels for easy mobility.', media: ['tool_chest.jpg'], category_id: Category.find_by(name: 'Hardware Items').id, vendor_id: Vendor.first.id, price: 299.99, quantity: 10, brand: 'ToolMaster', manufacturer: 'ToolCraft', package_length: 20, package_width: 12, package_height: 18, package_weight: 8.0 },
    { title: 'Hammer Set', description: 'Assorted hammer set with fiberglass handles for durability.', media: ['hammer_set.jpg'], category_id: Category.find_by(name: 'Hardware Items').id, vendor_id: Vendor.second.id, price: 49.99, quantity: 50, brand: 'ProHammer', manufacturer: 'HammerTech', package_length: 8, package_width: 4, package_height: 12, package_weight: 1.8 },
    { title: 'Electric Screwdriver', description: 'Electric screwdriver with rechargeable battery and multiple bit attachments.', media: ['electric_screwdriver.jpg'], category_id: Category.find_by(name: 'Hardware Items').id, vendor_id: Vendor.third.id, price: 79.99, quantity: 30, brand: 'PowerDriver', manufacturer: 'DriverTech', package_length: 10, package_width: 5, package_height: 14, package_weight: 2.0 },
    { title: 'Heavy Duty Saw', description: 'Professional heavy-duty saw for woodworking and construction projects.', media: ['heavy_duty_saw.jpg'], category_id: Category.find_by(name: 'Hardware Items').id, vendor_id: Vendor.first.id, price: 199.99, quantity: 20, brand: 'ProSaw', manufacturer: 'SawTech', package_length: 18, package_width: 8, package_height: 16, package_weight: 4.5 },

    # Automotive Spare Parts
    { title: 'Brake Pad Kit', description: 'Complete brake pad replacement kit for cars and trucks.', media: ['brake_pad_kit.jpg'], category_id: Category.find_by(name: 'Automotive Spare Parts').id, vendor_id: Vendor.second.id, price: 79.99, quantity: 60, brand: 'BrakeTech', manufacturer: 'AutoParts Inc', package_length: 12, package_width: 6, package_height: 8, package_weight: 3.2 },
    { title: 'Car Alternator', description: 'High-output car alternator for improved electrical system performance.', media: ['car_alternator.jpg'], category_id: Category.find_by(name: 'Automotive Spare Parts').id, vendor_id: Vendor.third.id, price: 149.99, quantity: 30, brand: 'PowerStart', manufacturer: 'AutoPower', package_length: 14, package_width: 7, package_height: 10, package_weight: 5.0 },
    { title: 'Engine Oil Filter', description: 'Premium engine oil filter for maintaining engine cleanliness.', media: ['engine_oil_filter.jpg'], category_id: Category.find_by(name: 'Automotive Spare Parts').id, vendor_id: Vendor.first.id, price: 19.99, quantity: 100, brand: 'FilterGuard', manufacturer: 'AutoFilters', package_length: 8, package_width: 4, package_height: 10, package_weight: 1.5 },
    { title: 'Tire Pressure Gauge', description: 'Digital tire pressure gauge with LCD display for accurate readings.', media: ['tire_pressure_gauge.jpg'], category_id: Category.find_by(name: 'Automotive Spare Parts').id, vendor_id: Vendor.second.id, price: 29.99, quantity: 150, brand: 'PressureMaster', manufacturer: 'AutoGauge', package_length: 6, package_width: 3, package_height: 1, package_weight: 0.5 },
    { title: 'Automotive Battery', description: 'Long-lasting automotive battery with high cold-cranking amps.', media: ['automotive_battery.jpg'], category_id: Category.find_by(name: 'Automotive Spare Parts').id, vendor_id: Vendor.third.id, price: 99.99, quantity: 50, brand: 'PowerPlus', manufacturer: 'AutoPower', package_length: 10, package_width: 6, package_height: 8, package_weight: 4.0 },

    # Computer Parts
    { title: 'Wireless Keyboard', description: 'Slim wireless keyboard with whisper-quiet keys for comfortable typing.', media: ['wireless_keyboard.jpg'], category_id: Category.find_by(name: 'Computer Parts').id, vendor_id: Vendor.first.id, price: 49.99, quantity: 100, brand: 'TechKeys', manufacturer: 'TechGear', package_length: 12, package_width: 5, package_height: 2, package_weight: 1.0 },
    { title: 'Gaming Mouse', description: 'High-precision gaming mouse with customizable RGB lighting.', media: ['gaming_mouse.jpg'], category_id: Category.find_by(name: 'Computer Parts').id, vendor_id: Vendor.second.id, price: 69.99, quantity: 80, brand: 'GamerTech', manufacturer: 'TechGear', package_length: 8, package_width: 4, package_height: 2, package_weight: 0.8 },
    { title: 'CPU Cooler', description: 'Efficient CPU cooler with heat pipes and quiet fan operation.', media: ['cpu_cooler.jpg'], category_id: Category.find_by(name: 'Computer Parts').id, vendor_id: Vendor.third.id, price: 39.99, quantity: 120, brand: 'CoolMaster', manufacturer: 'TechCooling', package_length: 14, package_width: 6, package_height: 4, package_weight: 0.7 },
    { title: 'Graphics Card', description: 'High-performance graphics card for smooth gaming and multimedia.', media: ['graphics_card.jpg'], category_id: Category.find_by(name: 'Computer Parts').id, vendor_id: Vendor.first.id, price: 299.99, quantity: 30, brand: 'PowerGFX', manufacturer: 'TechGraphics', package_length: 10, package_width: 5, package_height: 2, package_weight: 1.2 },
    { title: 'Solid State Drive (SSD)', description: 'Fast SSD storage drive for quick boot-up and file access.', media: ['ssd_drive.jpg'], category_id: Category.find_by(name: 'Computer Parts').id, vendor_id: Vendor.second.id, price: 129.99, quantity: 50, brand: 'TurboDrive', manufacturer: 'TechStorage', package_length: 8, package_width: 4, package_height: 1, package_weight: 0.5 },
]
